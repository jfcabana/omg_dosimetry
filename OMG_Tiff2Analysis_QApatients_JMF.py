...
#%% ################################## Entrer vos informations ci-dessous ##################################
    ...
    info = dict(author = 'JMF',
                ...
                date_exposed = '2022/01/10',
                date_scanned = '2022/01/11',
                wait_time = '22h',
    ...
    lut_file='P:\Projets\CRIC\Physique_Medicale\Films\Calibrations\C13_calib_18h_trans_300ppp_0-9Gy.pkl'

    #### Scan2Dose parameters ####
    clip = 10000  # Entrer une valeur en cGy maximum où couper la dose. Si 'None', n'applique pas de threshold.
    ...
    rot90 = 1           # Number of 90 degrees rotation to apply to film dose
     # Pour A1A: 0,1,0 salle 1
     #Pour C1A: 1,0,3 salle 1; 1,0,1 salle 3
    ...
    markers_center = [-1.5, -34, 275.6] # Coordinates of the makers intersection in mm (LR, IS, AP), as given in RayStation. = [-0.3, -722.7, 211] pour fantôme IMRT classique.
...
#    normalisation = 'norm_film'     # Si 'norm_film': sélectionne le film de normalisation pour calculer le facteur par rapport à une dose attendue
    ...
    threshold = 0.50         # Seuil de basses doses (0.1 = ne considère pas les doses < 10% du max de la dose ref)
