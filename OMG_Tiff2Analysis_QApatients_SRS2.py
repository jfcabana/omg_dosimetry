...
#%% ################################## Entrer vos informations ci-dessous ##################################
    ...
    info = dict(author = 'JFC',
                ...
                date_exposed = '2022-02-10',
                date_scanned = '2022-02-11',
                wait_time = '21h',
...
#    norm_thresh = 0.8
    ...
    rot_scan = 1 # Au besoin, mettre à 1 pour appliquer une rotation de 90 degrés sur l'image (si l'image de scan est verticale)
...
#    markers_center = [12.7, -28.20, 195.08] # Petit Goret centre film                                 
