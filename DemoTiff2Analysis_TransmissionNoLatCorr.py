...
#%% ################################## Entrer vos informations ci-dessous ##################################
    ...
    info = dict(author = 'MR',
                ...
                date_exposed = '2019/12/21',
                date_scanned = '2019/12/22',
                wait_time = '14 hr',
                notes = 'Scan en transmission avec la vitre.'
               )
    
    #### Set filenames and paths ####
    ID_patient = 'DemoTransmissionNoLatCorr'
    ID_plan = 'ThLSD_1A'
    ...
    dose_2_analysis_show_pdf = 1
    
    # Choisir le bon fichier de calibration en décommentant seulement la bonne ligne
    lut_file = '.\\DemoTransmissionNoLatCorr\\Calibration\\DemoCalibrationTransmissionNoLatCorr_0-28Gy.pkl'
