...
def retrieve_path_for_demo_files(name: str, force: bool = False) -> Path:
    """Retrieve the path directory to demo files.
    ...
    ----------
    name : str
        'calibration': Calibration demo files.
        _TODO: Add more parameters for other modules.
    """
    if name == 'calibration':

        base_url = "https://raw.githubusercontent.com/jfcabana/omg_dosimetry/OMG_master/scripts/demo/files/calibration/"
        tif_file_1 = "scan/C14_calib-18h-1_001.tif"
        tif_file_1 = "scan/C14_calib-18h-2_001.tif"
        beam_profile = "BeamProfile.txt"

        demo_path = Path(__file__) / "demo_files" / name
        demo_dir = demo_path.parent
