...
#%% ################################## Entrer vos informations ci-dessous ##################################
    #### Infos film ####
    info = dict(author = 'JMo',
                unit = '1',
                film_lot = 'C11',
                scanner_id = 'Epson 12000XL',
                date_exposed = '2022-09-19',
                date_scanned = '2022-09-20',
                wait_time = '16h',
...
#    elif info['film_lot'] == 'C13': lut_file = 'P:\Projets\CRIC\Physique_Medicale\Films\Calibrations\C13_calib_18h_trans_300ppp_0-3Gy.pkl'
    ...
    # nouvelle référence 2022-07-29 * Plaque mal insérée.
    #if orientation == 'sag': markers_center = [12.00, -30.35, 192.43] # Petit Goret sagittal.
    #if orientation == 'coro': markers_center = [11.78, -30.75, 191.90] # Petit Goret coronal.
    
    # nouvelle référence 2022-08-26
